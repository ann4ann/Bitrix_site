	...
	<?if (!empty($arResult["ERRORS"])):
		...
		<?if($arResult["SHOW_SMS_FIELD"] == true):?>
			...
			<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform">
				...
				<div class="row form-group">
					<div class="col-md-12 mb-3 mb-md-0">
						<?echo GetMessage("main_register_sms")?>
						<span class="starrequired">*</span>
					</div>
				</div>
				<div class="row form-group">
					<div class="col-md-12 mb-3 mb-md-0">
						<input class="form-control" size="30" type="text" name="SMS_CODE" value="<?=htmlspecialcharsbx($arResult["SMS_CODE"])?>" autocomplete="off" />
					</div>
				</div>
				<div class="row form-group">
					<div class="col-md-12 mb-3 mb-md-0">
						<input class="form-control" type="submit" name="code_submit_button" value="<?echo GetMessage("main_register_sms_send")?>" />
					</div>
				</div>
